...
function openModalFn(e) {
  ...
  refs.modalTitleEl.innerHTML = " House #".concat(e.target.id, " card");
}
...
require("./js/nav-panel");
},{"./js/modal":"js/modal.js","./js/nav-panel":"js/nav-panel.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
